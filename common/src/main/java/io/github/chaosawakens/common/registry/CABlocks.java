...
public final class CABlocks {
    ...
    // Mineral Blocks
    public static final Supplier<Block> AMETHYST_BLOCK = BlockPropertyWrapper.of(CABlockPropertyWrappers.MATERIAL_BLOCK_DIAMOND, registerBlock("amethyst_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLUE).strength(75.0F, 2400.0F).sound(SoundType.NETHERITE_BLOCK)), new Item.Properties().fireResistant())).getParentBlock();
