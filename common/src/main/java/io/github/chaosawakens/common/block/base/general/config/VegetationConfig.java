...
import io.github.chaosawakens.common.registry.CABlockPropertyWrappers;
...
public enum VegetationConfig implements StandardVegetationConfig { // This could probably be cleaner :skull:
    ...
    CRYSTAL(null, () -> new DefaultGrassVegetationConfig(Optional.empty()), () -> new DefaultPlantVegetationConfig(CABlocks.CRYSTAL_GRASS).withPlacementPredicate(targetState -> targetState.is(CABlocks.CRYSTAL_GRASS_BLOCK.get())));
