...
import io.github.chaosawakens.common.block.base.general.CustomizableFlowerBlock;
...
public class BigCarnivorousPlantBlock extends CustomizableFlowerBlock {
    ...
    public void entityInside(BlockState targetState, Level curLevel, BlockPos targetPos, Entity intersectingEntity) {
        intersectingEntity.hurt(CADamageEntries.CADamageSources.bigCarnivorousPlant(curLevel), 1.0F);
    }
}
